...
public class ReqJsonData {
	...
	private List<LocationInfoAlp> lctData;
	...
	private List<DeviceActive> Datas;
	...
	public List<LocationInfoAlp> getLctData() {
		return lctData;
	}

	public void setLctData(List<LocationInfoAlp> lctData) {
	...
	public List<DeviceActive> getDatas() {
		return Datas;
	}

	public void setDatas(List<DeviceActive> datas) {
		Datas = datas;
	}
