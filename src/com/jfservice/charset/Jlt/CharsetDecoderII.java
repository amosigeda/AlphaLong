...
import com.jfservice.common.client.DataBean;
...
public class CharsetDecoderII extends CumulativeProtocolDecoder {
	...
	protected boolean doDecode(IoSession session, IoBuffer in,
		...
		logger.info("in CharsetDecoderII dodecode session is ==============11111============="
				+ session);
		...
		System.out.println("remaining:"+inRemain+",ctx:"+ctx+",mathCount:"+matchCount);
		while (in.hasRemaining()) { // 变量解码的IoBuffer
			byte b = in.get();
			
			logger.info("bbbbbb------------"+Integer.toHexString(b&0xff));
...
//						 String s = dString.replaceAll(" ", "");
//						 s = s.substring(11,12);
//						 System.out.println("协议号：//////////////////////////"+s);
////						 System.out.println(s);
//						 dString = ChangeDecode(dString.replaceAll(" ", ""));
				...
				// 如果matchCount>0，说明没有匹配到文本换行eqw符的中的前一个匹配成功字节的下一个字节，
